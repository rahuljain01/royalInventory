...
const companies = [{'text': 'Kurl On', 'value': 1},{'text': 'Good luck', 'value': 2},{'text': 'Arora furnishers', 'value': 3},{'text': 'Ideal Furniture', 'value': 4}]
const fullWidthTextFieldStyle = { margin: '1rem 0 1rem 20rem',
                                  width: '1000px',
                                  height: '40px', 
                                  border: '1px solid' }
...
function PurchaseOrder(props) {
    ...
    return (
            ...
            {({ errors, values, touched, setValues }) => (
                <Form>
                    <div className="card m-3">
                        <div className="card-body border-bottom">
                            <div className="form-row">
                                <div className="form-group">
                                    <label style={ {margin: '1rem 0 1rem 20rem', width: '1000px', height: '40px'} }>Select Company</label>
                                    <Dropdown name='businessId'
                                                fluid
                                                search
                                                selection
                                                options={companies}
                        ...
                        <div className="card-body border-bottom">
                            <div className="form-row">
                                ...
                                <label style={ {margin: '1rem 0 1rem 20rem', width: '100px', height: '40px'} }>Invoice Date</label>
                                    <Field name="invoiceDate" type='text' style={ {margin: '1rem 0 1rem 2rem', width: '300px', height: '40px', borderWidth:'1px solid'} }>
                                        ...
                                        <div className="form-row">
                                            <div className="form-group col-6" style={ {margin: '1rem 0 1rem 20rem', width: '1000px', height: '40px'} }>
                                                ...
                                                <div style={ {marginLeft: '40%',width: '100%'}}>
                                                    ...
                                                    <Field name={`items.${i}.quantity`} type="number" style={{height:'40px', width:'450px', borderWidth:'1px solid'}} />
                        ...
                        <StyledDiv style={{width: '200px', justifyContent: 'left', float: 'right'}} >
                        <button className="link" type="button" onClick={e => {setShouldShowPopup(true)}}>
                                <span className="icon icon-add bg-green ml-10"></span>
                                    Add New Item
                        </button>
                        </StyledDiv>
                        <StyledDiv style={{ marginTop:'100px',height:'40px',display: 'inline-block', width:'300px' }}>
                            <button type="submit" style={{height:'40px', backgroundColor:'#4CAF50', width:'140px', float: 'left', color: 'white', borderRadius:'4px', border: '0px'}}>
        ...
        {shouldShowPopup ? <PopUp shouldShowPopup={shouldShowPopup} onClose={setShouldShowPopup}/>:null}
        </div>
    )
}
